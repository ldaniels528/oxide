...
<h4>▶️ Iteration</h4>
<h5>example¹</h5>
<pre>for row in ['apple', 'berry', 'kiwi', 'lime']::to(Table)
    yield row::value</pre>
<h5>results</h5>
<pre>
...
<h4>▶️ Method Call</h4>
<h5>example¹</h5>
<pre>['apple', 'berry', 'kiwi', 'lime']::to(Table)</pre>
<h5>results</h5>
<pre>
|------------|
| id | value |
...
<hr>
<h4>▶️ Platform Function Capture</h4>
<h5>example¹</h5>
<pre>stocks = []
...
<hr>
<h4>▶️ User Function Capture</h4>
<h5>example¹</h5>
<pre>fn multiply(n) -> n * 2
value = 8
value<:::multiply()
value</pre>
<h5>results</h5>
