...
use crate::packages::PackageOps::Cal;
...
impl Package for CalPkg {
    ...
    fn get_examples(&self) -> Vec<String> {
        match self {
            ...
            CalPkg::DateMonth => vec![strip_margin(r#"
                    |2025-07-06T21:59:02.425Z::month
                "#,
                '|',
            )],
            CalPkg::DateSecond => vec![strip_margin(r#"
            ...
            CalPkg::Minus => vec![strip_margin(r#"
...
impl StringsPkg {
    ...
    fn do_str_to_chars(
        ...
        Ok((ms, ArrayValue(Array::from(
            string_to_char_values(pull_string(string_val)?.as_str())
        ))))
    }
...
impl ToolsPkg {
    ...
    pub(crate) fn do_tools_push(
        ...
        match row_like {
            ...
            z => throw(TypeMismatch(StructExpected(z.get_type_decl(), z.to_code()))),
        }
    }
        ...
        match self {
            ...
            ToolsPkg::RowId => vec![
                strip_margin(r#"
                    ...
                    |    | JTRQ   | OTHER_OTC | 0.0001    |
                    |    |--------------------------------|
                    |for row in stocks yield tools::row_id()
                "#, '|')
            ],
            ToolsPkg::Scan => vec![
                strip_margin(r#"
...
impl UtilsPkg {
    ...
    fn do_util_to_xxx(
        ...
        match to_type { 
            Kind(data_type) => Ok((ms, value.convert_to(data_type.clone())?)),
            other => {
...
mod tests {
    ...
    fn test_to_code() {
        ...
        assert_eq!(Strings(StringsPkg::ToChars).to_code(), "str::to_chars()");
